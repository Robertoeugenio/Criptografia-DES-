...
//------------------------------------------- Encriptando chave -------------------------------------------------
	           ...
	           // executando 16 turnos circulares esquerdos dos originais LK e RK
	            ...
	            // construindo as 16 chaves secundárias de 48 bits usando a tabela PC-2
...
//-----------------------------------Encriptando texto-----------------------------------------------------------
	          ...
	          //  Converte uma seqüência de caracteres alfanuméricos em seus dígitos hexadecimais equivalentes.
	            pw.println();
	            pw.println("Texto em binário: " + binaryKey);
	            binaryKey = binaryKey.replace(" ", "");
	            ...
	            if (plainTextLength < 64) {
	                ...
	                for(int id = loop, wordCount = 1; id >0; id--, wordCount++) {
	                    ...
	                    //fazendo uma permutação inicial no texto simples	
	                    String IPBinary = "";
	                    for (int i : IP) {
	                 ...
	                 //  16 chaves, por isso, 16 rodadas
	                    ...
	                    for (String k : RoundKeyArray) {
	                        pw.println();
	                        pw.println("64-bit " + wordCount+ " Encriptação redonda " + counter + "     ");
	                        pw.println("Chave = " + k);
	                     ...
	                     // Bloco da direita é o bloco da esquerda 
	                        String expand = "";
	                        for (int i : E) {
	                            expand += RightIPBinary.charAt(i - 1);
	                         // Cada bloco de 4 bits originais foi expandido para um bloco de 6 bits de saída
	                        ...
	                        //para obter f, estou permutando a saída da caixa-S (binaryTarget) usando a tabela P para obter o valor final
	                        ...
	                        if (counter > 16) {
	                            ...
	                            finalResult = "";
	                            // Permutação Final FP: O inverso da permutação inicial IP
	                            for (int x : FP) {
	    ...
	    //Converter string em string binária
	    ...
	    /*Função de deslocamento à esquerda */
